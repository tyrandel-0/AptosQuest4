...
export async function pancakeSwap(privateKeys: string[], aptosClient: AptosClient, delay: DelayTimeRange) {
...
async function swapToUSDT(walletIndex: number, aptosAccount: AptosAccount, aptosClient: AptosClient, delay: number) {
